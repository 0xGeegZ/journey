  ...
  return (
    <VStack className={styles.container}>
      ...
      <VStack gap={10}>
        ...
        <VStack pb="5rem">
          <RewardPill label="Achievement: Fantom DeFi Expert" />
          <Box w="1" height="10px"></Box>
          <Image src="/ftm.gif" alt="sun" className={styles.achievementBadge} />
          <Box w="1" height="10px"></Box>
          <Button
