...
import { mockQuests, mockQuestSteps } from "@data/static";
...
function Quest() {
  ...
  // TODO: REMOVE TEMP BOOLS
  const fetchedQuest = mockQuests.find((q) => q.id === questId);
            ...
            <HStack width="100%" justifyContent="space-between" pb=".5rem">
              <Text>
                ...
                {isQuestRewarded || isQuestCompleted
                  ...
                  : !isQuestActive
                  ? "Not Started"
                  : `${currentStep}/${mockQuestSteps.length} completed`}
              </Text>
              <HStack>
                <Text>
